    ...
    return (
        <section id="skills" className="py-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans bg-skills clip-path-custom">
            ...
            <div className="text-center mb-8">
                ...
                <div className="w-24 h-1 bg-prim mx-auto mt-2">
                </div>
            ...
            <div className="flex flex-wrap gap-1 lg:gap-5 py-10 justify-between">
                {SkillsInfo.map((catergory) => (
                    <div key={catergory.title} className="bg-gray-900 backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 mb-10 w-full sm:w-[48%] rounded-2xl border border-white shadow-[0_0_20px_1px_rgba_(130, 69, 236, 0.3)]">
                        <h3 className="text-2xl sm:text-3xl font-semibold text-gray-400 mb-4 text-center">
                            {catergory.title}
                        </h3>
                        {/* Skills Items - 3 per row on larger screen  */}
                        <ReactParallaxTilt tiltMaxAngleX={20} tiltMaxAngleY={20} perspective={1000} scale={1.05} transitionSpeed={1000} gyroscope={true}>
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full">
                                {
                                    catergory.skills.map((skill) => (
